...
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    private static final String[] SUPER_PERMISSION_PATH_ARR = {
            ...
            "/mobile/module/**",
            "/flw/model/**",
            "/flw/templatePrint/page",
            "/flw/templatePrint/add",
            "/flw/templatePrint/edit",
            "/flw/templatePrint/design",
            "/flw/templatePrint/delete",
            "/flw/templatePrint/detail",
            "/flw/templatePrint/flwTemplatePrintSelector",
            "/flw/templateSn/**",
            "/pay/**",
            "/urp/**",
            "/dbs/**",
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/favicon.ico").addResourceLocations(ResourceUtils.CLASSPATH_URL_PREFIX);
        ...
        registry.addResourceHandler("/ureport/res/**").addResourceLocations(ResourceUtils.CLASSPATH_URL_PREFIX + "/META-INF/resources/ureport-asserts/");
    }
